...
data3 = np.loadtxt(f'../result_alia/data_{iter3}.txt')
Z3 = np.loadtxt(f'../result_alia/z_{iter3}.txt')
x3 = np.loadtxt(f'../result_alia/x_{iter3}.txt')
y3 = np.loadtxt(f'../result_alia/y_{iter3}.txt')
